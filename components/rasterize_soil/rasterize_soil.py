...
<p>Field of the Soil Layer representing the hydrologic soil group (HSG). The picklist values comes from the fields in the Soil Layer. This will default to 'hydgrpdcd' if it is present in the Soil Layer. If this is left emtpy, no HSG raster will be created.</p>
...
<p>The output location of the Hydrologic Soil Group raster. The raster will inherit the CRS of the Soil Layer.</p>
<h3>K-Factor Raster</h3>
<p>The output location of the K-Factor raster. The raster will inherit the CRS of the Soil Layer.</p>
<br></body></html>"""
